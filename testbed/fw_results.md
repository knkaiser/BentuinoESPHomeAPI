...
| TS-2.5 | MUST | online | SKIP | device not using encryption |
| TS-2.3 | MUST | online | SKIP | device not using encryption |
| TS-2.10 | MUST | online | SKIP | device not using encryption |
...
| TS-7.2 | MUST | online | PASS | state sensor key=0x4EEE9F69 value=8.003000259399414 |
...
| TS-10-LOG | MUST | online | PASS | level=5 msg='sim heartbeat uptime=10s' |
| TS-13-HA-SVC | MUST | online | PASS | event='esphome.sim_heartbeat' data=[('uptime', '12')] |
...
| TS-12.2 | MUST | online | PASS | server responded (0 bytes) then should close |
